    ...
    <>
      ...
      <div className='flex'>
        ...
        <div className='heading w-full '>
          <h1 className='text-3xl text-center mt-20 font-bold tracking-[1px]' >GR's Hospital</h1>
          <p className='mt-10 text-xl tracking-[1px]'>“Medicines cure diseases, but only doctors can cure patients.”</p>
        </div>
        <form className='w-full h-[70vh] flex justify-center items-center' >
          ...
          <div className=' w-full '>
            ...
            <p className='mt-3 font-semibold' style={{ letterSpacing: '1px' }}> For More Login
              <Link to='/HomePage' className='text-blue-700 underline ml-2'>Click here</Link>
            </p>
          </div>
